...
Trees generated with `-b 100` that exceeded ~ 1000 samples timed out after 7 days running with 64GB memory. Trees with 20 nonparametric bootstrap replicates (`-b 20`) also became intractable beyond ~ 5000 tips. Ten replicates worked across all trees in the dataset but is insufficient to conclude clade support. Note the [difference in interpretation](https://iqtree.github.io/doc/Frequently-Asked-Questions#how-do-i-interpret-ultrafast-bootstrap-ufboot-support-values) of UltraFast bootstrap support values compared to standard support values. 
